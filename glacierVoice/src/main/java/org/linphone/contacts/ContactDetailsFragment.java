...
public class ContactDetailsFragment extends Fragment implements ContactsUpdatedListener {
                        ...
                        delete.setOnClickListener(
                                new OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        // delete profile from VCard
                                        ContactsManager.getInstance()
                                                .deleteContactFromVCard(mContact.getFullName());
    ...
    private void displayContact(LayoutInflater inflater, View view) {
        ...
        for (LinphoneNumberOrAddress noa : mContact.getNumbersOrAddresses()) {
            ...
            tv.setText(getDisplayName(displayedNumberOrAddress));
            tv.setSelected(true);
    ...
    /**
     * Get numerical portion of address
     *
     * @param uri
     * @return
     */
