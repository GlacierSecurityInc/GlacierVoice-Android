...
public abstract class MainActivity extends LinphoneGenericActivity
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            ...
                            // go to download messenger in playstore
                            Intent intent = new Intent(Intent.ACTION_VIEW);
                            intent.setData(
                                    Uri.parse(
                                            "https://play.google.com/store/apps/details?id=com.glaciersecurity.glaciermessenger"));
                        ...
                        if (state == RegistrationState.Ok) {
                            if (Version.sdkAboveOrEqual(Version.API23_MARSHMALLOW_60)) {
                                ...
                                try {
                                                ...
                                                (dialog, which) -> {
                                                    ...
                                                    try {
                                                        startActivityForResult(
                                                                intent, REQUEST_BATTERY_OP);
                                                    } catch (ActivityNotFoundException e) {
                                                        Toast.makeText(
                                                                        MainActivity.this,
                                                                        "This device does not support battery optimization",
                                                                        Toast.LENGTH_SHORT)
                                                                .show();
                                                    }
                                                });
                                    ...
                                    Log.e("Failed in checking for Battery Optimizations");
                                }
                            }
    ...
    private void quit() {
        ...
        } // Properly stops app if select Quit
