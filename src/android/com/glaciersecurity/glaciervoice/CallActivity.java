...
import org.glaciersecurity.glaciervoice.core.LinphoneCallStats.LinphoneAddressFamily;
...
import org.glaciersecurity.glaciervoice.core.LinphonePlayer;
...
import org.glaciersecurity.glaciervoice.ui.Numpad;
...
//		Hiding controls to let displayVideoCallControlsIfHidden add them plus the callback
	...
	private String getEncoderText(String mime){
		...
		if (ret == null){
			org.glaciersecurity.glaciervoice.mediastream.Factory msfactory = LinphoneManager.getLc().getMSFactory();
