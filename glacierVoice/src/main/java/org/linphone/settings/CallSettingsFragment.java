    ...
    private void setListeners() {
        ...
        mDtmfSipInfo.setListener(
                new SettingListenerBase() {
                    @Override
                    public void onBoolValueChanged(boolean newValue) {
                        // if (newValue) mDtmfRfc2833.setChecked(false); // Feb 5 2020 update to fix
                        // DTMF mode
                        mPrefs.sendDTMFsAsSipInfo(newValue);
                        if (!newValue
                                && !mDtmfRfc2833
                                        .isChecked()) { // Feb 5 2020 update to fix DTMF mode
        ...
        mDtmfRfc2833.setListener(
                new SettingListenerBase() {
                    @Override
                    public void onBoolValueChanged(boolean newValue) {
                        // if (newValue) mDtmfSipInfo.setChecked(false); // Feb 5 2020 update to fix
                        // DTMF mode
