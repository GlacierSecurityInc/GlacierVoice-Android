...
public class HistoryDetailFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        // remove visibility since we are using messenger
    ...
    private void displayHistory() {
        ...
        String username_sip = LinphonePreferences.instance().getAccountUsername(0);
        String domain_sip = LinphonePreferences.instance().getAccountDomain(0);
        String id = "sip:" + username_sip + "@" + domain_sip;

        if (mSipUri != null) {

            String caller_sip = getDisplayName(mSipUri);
            ...
            if (address != null && core != null) {
                ...
                if (proxyConfig != null) {
                    ...
                    logs_proxy = core.getCallHistory(address, proxyConfig.getIdentityAddress());
                } else {
                    logs = core.getCallHistoryForAddress(address);
                    logs_proxy = core.getCallHistoryForAddress(address);
                }

                List<CallLog> logsList = Arrays.asList(logs);
                List<CallLog> logsproxyList = Arrays.asList(logs_proxy);
                ...
                mContactAddress.setText(LinphoneUtils.getAddressDisplayName(address));
