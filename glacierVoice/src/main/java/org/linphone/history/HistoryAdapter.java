...
public class HistoryAdapter extends SelectableAdapter<HistoryViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final HistoryViewHolder holder, final int position) {
        ...
        holder.histcalltime.setSelected(true);
        ...
        // Set time of call
        holder.histcalltime.setText(calllogtimestampToHumanDate(logTime));
    ...
    @SuppressLint("SimpleDateFormat")
    private String calllogtimestampToHumanDate(Calendar cal) {
        SimpleDateFormat dateFormat;
        dateFormat = new SimpleDateFormat(mActivity.getString(R.string.call_log_time_format));
        return dateFormat.format(cal.getTime());
    }
