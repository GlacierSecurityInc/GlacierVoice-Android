...
class ApiTwentySixPlus {
    ...
    public static Notification createIncomingCallNotification(
        ...
        notificationLayoutHeadsUp.setTextViewText(R.id.sip_uri, sipUri); // DOPE
        ...
        return new Notification.Builder(
                ...
                .setSmallIcon(R.drawable.ic_dial_phone_icon_blue4)
                .setLargeIcon(contactIcon)
                .setContentTitle(contactName)
    ...
    public static Notification createMissedCallNotification(
        ...
        return new Notification.Builder(
                ...
                .setContentTitle(title)
                .setContentText(text)
                .setSmallIcon(R.drawable.ic_dial_phone_icon_blue_missed6)
                .setAutoCancel(true)
                .setContentIntent(intent)
